...
<body>
  <div class="container-fluid">
    <h2 class="text-center whitee">KUIS 2 Muhammad Fauzan Tri Aji</h2>
    <p class="datatable design text-center whitee">1931710150 - Sistem Terdistribusi</p>
    <div class="row">
      <div class="container">
        <div class="btnAdd">
         <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal"   class="btn btn-grad" >Add User</a>
       </div>
       <div class="row testt">
